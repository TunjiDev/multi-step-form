      ...
      <div className={styles["radio-wrapper"]}>
        <div className={styles.radio}>
          ...
          <label htmlFor="Arcade">
            ...
            <p className="muted">
              ${!planLength ? planOptions.Arcade.monthly : planOptions.Arcade.yearly}/{!planLength ? "mo" : "yr"}
            </p>
        ...
        <div className={styles.radio}>
          ...
          <label htmlFor="Advanced">
            ...
            <p className="muted">
              ${!planLength ? planOptions.Advanced.monthly : planOptions.Advanced.yearly}/{!planLength ? "mo" : "yr"}
            </p>
            {planLength && <p>2 months free</p>}
          </label>
          <input
        ...
        <div className={styles.radio}>
          ...
          <label htmlFor="Pro">
            ...
            <p className="muted">
              ${!planLength ? planOptions.Pro.monthly : planOptions.Pro.yearly}/{!planLength ? "mo" : "yr"}
            </p>
            {planLength && <p>2 months free</p>}
          </label>
          <input
